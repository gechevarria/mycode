 ...
 */
public class Config {	
	public static String EDI_MESSAGES_FOLDER = null;
	public static String PENDING_TO_BE_SENT_EDI_FILES = null;
	public static String ALREADY_SENT_EDI_MESSAGES_FOLDER = null;
	...
	public static void init() {
		...
		prop.load(input);		
		EDI_MESSAGES_FOLDER = prop.getProperty("EDI_MESSAGES_FOLDER");
		ALREADY_SENT_EDI_MESSAGES_FOLDER = prop.getProperty("ALREADY_SENT_EDI_MESSAGES_FOLDER");
