...
public class PresentationLayerReusabilityConditionsWindow {
	...
	protected void createContents() {
		...
		lblSelectPresentationLayers.setFont(SWTResourceManager.getFont("Tahoma", 8, SWT.BOLD));
		...
		lblSameTechnologyOn.setFont(SWTResourceManager.getFont("Tahoma", 8, SWT.BOLD));
